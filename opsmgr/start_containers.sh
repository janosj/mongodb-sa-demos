...
# Parameters added by J Janos
# 2702x allows access to MDB (27021|2|3)
# 2703x allows .... ?
# 3306x allows .... ?
# -v provides access to content on the host from the containers.
JJ_ADDED_PARAMS="-p 2702\${i}:2702\${i} -p 2703\${i}:2703\${i} -p 3306\${i}:3306\${i} -v /etc/pykmip/certs:/etc/pykmip/certs"
